...
| GGUF model loading                     | GGUFLoader doc + PRD      | Partial | MVP `GGUFLoader` module parses header, metadata, and tensor info                  | Implement full dequantization and GPU transfer mapping                        |
...
| SimulationEngine abstraction           | PRD + diagrams            | Partial | `SimulationEngine` module created, execution graph, and activation cache wired    | Promote simulation slice into dedicated engine API                            |
